...
const _appBskyActorProfileSchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(
		/*#__PURE__*/ v.literal('rsvp.atmo.declaration.listRecords#appBskyActorProfile')
	),
	/**
...
const _mainSchema = /*#__PURE__*/ v.query('rsvp.atmo.declaration.listRecords', {
	params: /*#__PURE__*/ v.object({
		 ...
		 */
		sort: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.string<'createdAt' | (string & {})>())
	}),
	output: {
		type: 'lex',
...
const _profileEntrySchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(
		/*#__PURE__*/ v.literal('rsvp.atmo.declaration.listRecords#profileEntry')
	),
...
const _recordSchema = /*#__PURE__*/ v.object({
	$type: /*#__PURE__*/ v.optional(
		/*#__PURE__*/ v.literal('rsvp.atmo.declaration.listRecords#record')
	),
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		'rsvp.atmo.declaration.listRecords': mainSchema;
	}
}

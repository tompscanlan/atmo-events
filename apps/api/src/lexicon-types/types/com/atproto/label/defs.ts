...
const _labelValueSchema = /*#__PURE__*/ v.string<"!hide" | "!no-unauthenticated" | "!warn" | "bot" | "graphic-media" | "nudity" | "porn" | "sexual" | (string & {})>();
...
const _labelValueDefinitionStringsSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("com.atproto.label.defs#labelValueDefinitionStrings")),
		/**
...
const _selfLabelsSchema = /*#__PURE__*/ v.object(
	{
		...
		get "values"() {
			return /*#__PURE__*/ v.constrain(
				/*#__PURE__*/ v.array(selfLabelSchema),
...
export const labelValueDefinitionStringsSchema = _labelValueDefinitionStringsSchema as labelValueDefinitionStringsSchema;

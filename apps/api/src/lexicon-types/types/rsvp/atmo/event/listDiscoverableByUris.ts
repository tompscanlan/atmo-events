...
const _hydrateRsvpsSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("rsvp.atmo.event.listDiscoverableByUris#hydrateRsvps")),
		get "going"() {
...
const _hydrateRsvpsRecordSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("rsvp.atmo.event.listDiscoverableByUris#hydrateRsvpsRecord")),
		...
		"params": /*#__PURE__*/ v.object(
			{
				...
				/**
				 * Comma-separated canonical event AT URIs. At most 60 entries are considered.
				 */
				"uris": /*#__PURE__*/ v.string(),
			}
		),
		"output": {
			"type": "lex",
...
const _profileEntrySchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("rsvp.atmo.event.listDiscoverableByUris#profileEntry")),
		"cid": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.cidString()),
...
const _recordSchema = /*#__PURE__*/ v.object(
	{
		"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("rsvp.atmo.event.listDiscoverableByUris#record")),
...
declare module '@atcute/lexicons/ambient' {
	interface XRPCQueries {
		"rsvp.atmo.event.listDiscoverableByUris": mainSchema;
	}
}
